                    ...
                    <form action="{{ route('coupon.update', $coupon->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-6 gap-2">
                            ...
                            <div class="col-span-2 sm:col-span-2">
                                ...
                                <x-form-input type="number" min="0" step="any" name="coupon_used" id="coupon_used" value="{{ $coupon->coupon_used }}" />
                            </div>
                            <div class="col-span-2 sm:col-span-2">
                                <x-label for="coupon_available" class="font-semibold">Coupon Available</x-label>
                                <x-form-input type="number" min="0" step="any" name="coupon_available" id="coupon_available" value="{{ $coupon->coupon_available }}" />
                            </div>
                            <div class="col-span-3 sm:col-span-3">
