    ...
    <div class="mx-auto sm:px-6 lg:px-8 py-6">
        ...
        <div class="mt-12 mx-auto">
            <data-table v-slot="{ params, setParam, data, links, meta, next, prev, loading }"
                        ...
                        url="{{route('expense-income.fetch')}}"
            >
                    ...
                    <x-slot name="body">
                        <tr>
                            ...
                            <td class="text-center border-b-2 border-gray-300 px-3">
                                <input @input="setParam('authorized', $event.target.value)" name="authorized" class="form-input w-full mx-auto my-3 py-2 px-3 bg-gray-200 rounded shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out leading-none" />
                            </td>
                            <td class="text-center border-b-2 border-gray-300 px-3">
                            ...
                            <td class="text-center border-b-2 border-gray-300 px-3">
                                <input @input="setParam('created_by', $event.target.value)" name="created_by" class="form-input w-full mx-auto my-3 py-2 px-3 bg-gray-200 rounded shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out leading-none" />
                            </td>
