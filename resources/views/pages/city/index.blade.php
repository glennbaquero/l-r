                ...
                <x-table :headers="$headers">
                    <x-slot name="body">
                        ...
                        <template v-if="data.length > 0">
                            <tr v-for="(city, key) in data" :key="key" class="hover:bg-gray-100 cursor-pointer">
                                ...
                                <td class="px-6 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-medium text-gray-500 flex py-5">
                                    <delete-button :url="city.deleteUrl"></delete-button>
                                    <a :href="city.showUrl" class="focus:outline-none focus:shadow-outline inline-flex">
