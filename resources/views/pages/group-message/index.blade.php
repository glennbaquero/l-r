                ...
                <x-table :headers="$headers">
                    <x-slot name="body">
                        ...
                        <template v-if="data.length > 0">
                            <tr v-for="(message, key) in data" :key="key" class="hover:bg-gray-100 cursor-pointer">
                                ...
                                <td class="px-6 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-medium text-gray-500 flex py-5">
                                    <delete-button :url="message.deleteUrl"></delete-button>
                                    <a :href="message.showUrl" class="focus:outline-none focus:shadow-outline inline-flex">
                            ...
                            <!--Pagination-->
                            <tr>
                                <td class="px-6 py-2 whitespace-no-wrap text-left border-b border-gray-200 text-sm leading-5 font-medium text-gray-900">
                                    Showing @{{meta.from}} to @{{meta.to}} of @{{meta.total}}
                                </td>
                                <td class="px-6 py-2 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium text-gray-900">
                        ...
                        <template v-else>
                            <tr>
                                <td colspan="2" class="px-6 py-2 whitespace-no-wrap text-center border-b border-gray-200 text-sm leading-5 font-medium text-gray-900">
                                    No Record . . .
                                </td>
                            </tr>
                        </template>
