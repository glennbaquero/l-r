    ...
    <div class="mx-auto sm:px-6 lg:px-8 py-6">
        <div class="flex items-center">
            <div class="text-base mr-auto">
                ...
                <x-breadcrumb currentModule="{{__('Bus Model Management')}}" route="{{ route('bus-model.index') }}"></x-breadcrumb>
            </div>
        </div>
        ...
        <div class="mt-12 mx-auto w-4/5">
            <div class="bg-white shadow sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <bus-generator v-slot="{ bus, cellChange, default_cell, rows, columns, showCellType, updateType, updateTypeCell, selectColumn, selectedColumn, changeCellType, changeCellOrientation, toJson }" :cells="{{ $cells }}">
                        <form action="{{ route('bus-model.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-span-1">
                                    <div class=" grid grid-cols-2 gap-2">
                                         ...
                                         <div class="col-span-1/2 sm:col-span-1/2">
                                             ...
                                             <x-form-input type="number" name="seats" id="seats" value="{{ old('seats') }}" />
                                         </div>
                                         <div class="col-span-1/2 sm:col-span-1/2">
