    ...
    <div class="mx-auto sm:px-6 lg:px-8 py-6">
        <div class="flex items-center">
            <div class="text-base mr-auto">
                ...
                <x-breadcrumb currentModule="{{__('Payment Document Management')}}" route="{{ route('payment-document.index') }}"></x-breadcrumb>
            </div>
        </div>
                    ...
                    <form action="{{ route('payment-document.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-6 gap-6" >
                            <div class="col-span-3 sm:col-span-3">
                                ...
                                <x-form-input type="text" name="document_number" id="document_number" value="{{ old('document_number') }}" />
                            </div>
