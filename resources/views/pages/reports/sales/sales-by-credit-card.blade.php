    ...
    <div class="mx-auto sm:px-6 lg:px-8 py-6">
        <div class="flex items-center">
            <div class="text-base mr-auto">
                <span class="font-semibold mr-3">{{__('Sales By Credit Card')}}</span>
            </div>
        </div>
                                ...
                                <div :class="display ? 'col-span-3 sm:col-span-3' : 'col-span-1 sm:col-span-1'" class=" grid grid-cols-3 gap-3">
                                    <div class="col-span-1 sm:col-span-1 mx-auto">
                                        ...
                                        <div class="flex items-center space-x-3 mt-3">
                                            <span id="toggleLabel">
                                                <span class="text-sm leading-5 font-medium text-gray-900">Transaction </span>
                                            </span>
                                            ...
                                            <span id="toggleLabel">
                                                <span class="text-sm leading-5 font-medium text-gray-900">Concept  </span>
                                            </span>
