                ...
                <div class="mt-10">
                    ...
                    <toggle>
                        <div slot-scope="{ display, toggled }" class="relative">
                            ...
                            <input tabindex="2" id="password" :type="display ? 'text' : 'password'" name="password" required class="appearance-none block w-full pl-12 py-2 border border-white bg-transparent rounded-full placeholder-gray-400 tracking-wider focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:leading-8 @error('password') border-red-500 @enderror" :class="display ? 'sm:text-sm' : 'sm:text-xl'" />

                            <span class="absolute inset-y-0 right-0 flex items-center pr-2">
                                <button @click.prevent="toggled" class="p-1 focus:outline-none focus:shadow-outline">
