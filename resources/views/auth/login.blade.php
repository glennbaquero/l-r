    ...
    <div class="mt-8 sm:ml-40 sm:w-full sm:max-w-md">
        <div class="py-8 px-4 sm:rounded-lg sm:px-10">
          <form action="{{ route('login') }}" method="POST" method="POST">
            ...
            <div>
                <label for="text" class="block text-sm font-medium leading-5 mb-2 @error('username') text-red-500 @enderror">
                    {{ __('Username')}}
                </label>
                <div class="relative">
                    ...
                    <input type="text" id="username" name="username" value="{{old('username')}}" required class="appearance-none block w-full pl-12 py-2 border border-white bg-transparent rounded-full placeholder-gray-400 tracking-wider focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-8 @error('username') border-red-500 @enderror" />
                </div>
                @error('username')
            ...
            <div class="mt-10">
                ...
                <toggle-password>
                    <div slot-scope="{ display, toggle }" class="relative">
                        ...
                        <span class="absolute inset-y-0 right-0 flex items-center pr-2">
                            <button @click.prevent="toggle" class="p-1 focus:outline-none focus:shadow-outline">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <div class="text-sm leading-5">
                    <a href="#" class="font-medium focus:outline-none focus:underline transition ease-in-out duration-150">
