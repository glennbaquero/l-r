<template>
	<div>
		<div class="fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-50 overflow-hidden bg-red-700 opacity-75 flex flex-col items-center justify-center" v-if="display">
